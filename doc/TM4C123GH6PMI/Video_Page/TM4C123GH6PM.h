...
void GPIO_Port_A_handler(void);
void GPIO_Port_B_handler(void);
void GPIO_Port_C_handler(void);
void GPIO_Port_D_handler(void);
void GPIO_Port_E_handler(void);
void UART0_handler(void);
void UART1_handler(void);
void SSI0_handler(void);
void I2C0_handler(void);
void PWM0_Fault_handler(void);
void PWM0_Generator_0_handler(void);
void PWM0_Generator_1_handler(void);
void PWM0_Generator_2_handler(void);
void QEI0_handler(void);
void ADC0_Sequence_0_handler(void);
void ADC0_Sequence_1_handler(void);
void ADC0_Sequence_2_handler(void);
void ADC0_Sequence_3_handler(void);
void Watchdog_Timers_0_1_handler(void);
void Timer_0A_16_32_handler(void);
void Timer_0B_16_32_handler(void);
void Timer_1A_16_32_handler(void);
void Timer_1B_16_32_handler(void);
void Timer_2A_16_32_handler(void);
void Timer_2B_16_32_handler(void);
void Analog_Comparator_0_handler(void);
void Analog_Comparator_1_handler(void);
void System_Control_handler(void);
void Flash_and_EEPROM_Control_handler(void);
void GPIO_Port_F_handler(void);
void UART2_handler(void);
void SSI1_handler(void);
void Timer_3A_16_32_handler(void);
void Timer_3B_16_32_handler(void);
void I2C1_handler(void);
void QEI1_handler(void);
void CAN0_handler(void);
void CAN1_handler(void);
void Hibernation_Module_handler(void);
void USB_handler(void);
void PWM_Generator_3_handler(void);
void uDMA_Software_handler(void);
void uDMA_Error_handler(void);
void ADC1_Sequence_0_handler(void);
void ADC1_Sequence_1_handler(void);
void ADC1_Sequence_2_handler(void);
void ADC1_Sequence_3_handler(void);
...
void Timer_4A_16_32_handler(void);
void Timer_4B_16_32_handler(void);
void Timer_5A_16_32_handler(void);
void Timer_5B_16_32_handler(void);
void Timer_0A_32_64_handler(void);
void Timer_0B_32_64_handler(void);
void Timer_1A_32_64_handler(void);
void Timer_1B_32_64_handler(void);
void Timer_2A_32_64_handler(void);
void Timer_2B_32_64_handler(void);
void Timer_3A_32_64_handler(void);
void Timer_3B_32_64_handler(void);
void Timer_4A_32_64_handler(void);
void Timer_4B_32_64_handler(void);
void Timer_5A_32_64_handler(void);
void Timer_5B_32_64_handler(void);
void System_Exception_handler(void);
void PWM1_Generator_0_handler(void);
void PWM1_Generator_1_handler(void);
void PWM1_Generator_2_handler(void);
void PWM1_Generator_3_handler(void);
void PWM1_Fault_handler(void);
